...
```
```{r, eval = TRUE} 
altruism_regression <- lm(formula = vignette_response ~ condition + age_bracket, data = data)
summary(altruism_regression)
```
```{r, eval = TRUE} 
altruism_interaction_regression <- lm(formula = vignette_response ~ condition * age_bracket, data = data)
summary(altruism_interaction_regression)
```
